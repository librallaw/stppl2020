(function($) {
    ...
    $(document).ready(function() {
        ...
        var launchDay = new Date(2020, 12 - 1, 5);
        ...
        $(
            '<div class="spinner"><div class="square"></div><div class="square"></div><div class="square"></div><div class="square"></div></div>'
        )
            .hide()
            .appendTo('.newsletter');
                ...
                $.post($(form).attr('action'), $(form).serialize(), function(data) {
                    $('.newsletter').find('.spinner').animate({ opacity: 0 }, function() {
                        ...
                        $('.newsletter')
                            .find('.success')
                            .show()
                            .html('<i class="icon ion-ios7-checkmark-outline"></i> Thank you for subscribing!')
                            .animate({ opacity: 1 });
                    });
                });
                return false;
    ...
    function jgtMinHeight() {
        var leftWrap = $('.left-wrap'), rightWrap = $('.right-wrap');
    ...
    function jgtGoogleMap() {
        ...
        var mapLat = 37.77493, mapLong = -122.419416, mapInfo = '<div id="content">HalfTime Studio</div>';
